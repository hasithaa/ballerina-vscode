...
const NODE_ICONS: Record<NodeKind, React.FC<{ size: number; color: string; isDBConnection?: boolean }>> = {
    ...
    DURABLE_AGENT_MODEL_PROVIDER: ({ size, color }) => <Icon name="bi-ai-model" sx={{ fontSize: size, width: size, height: size, color }} />,
    DURABLE_AGENT_ADD_ACTIVITY: ({ size, color }) => <Icon name="bi-task" sx={{ fontSize: size, width: size, height: size, color }} />,
    DURABLE_AGENT_ADD_TOOL: ({ size, color }) => <Icon name="bi-function" sx={{ fontSize: size, width: size, height: size, color }} />,
    DURABLE_AGENT_HUMAN_TASK: ({ size, color }) => <Icon name="bi-user" sx={{ fontSize: size, width: size, height: size, color }} />,
