...
const NODE_ICONS: Record<NodeKind, React.FC<{ size: number; color: string; isDBConnection?: boolean }>> = {
    ...
    DURABLE_AGENT: ({ size, color }) => <Icon name="bi-ai-agent" sx={{ fontSize: size, width: size, height: size, color }} />,
    DURABLE_AGENT_ADD_ACTIVITY: ({ size, color }) => <Icon name="bi-settings" sx={{ fontSize: size, width: size, height: size, color }} />,
    DURABLE_AGENT_HUMAN_TASK: ({ size, color }) => <Icon name="bi-settings" sx={{ fontSize: size, width: size, height: size, color }} />,
    DURABLE_AGENT_REGISTER_EVENT: ({ size, color }) => <Icon name="bi-settings" sx={{ fontSize: size, width: size, height: size, color }} />,
    DURABLE_AGENT_REGISTER_TOOL: ({ size, color }) => <Icon name="bi-settings" sx={{ fontSize: size, width: size, height: size, color }} />,
    DURABLE_AGENT_RUN: ({ size, color }) => <Icon name="bi-ai-agent" sx={{ fontSize: size, width: size, height: size, color }} />,
    DURABLE_AGENT_UPDATE: ({ size, color }) => <Icon name="bi-arrow-outward" sx={{ fontSize: size, width: size, height: size, color }} />,
